...
Portanto, como menção final, o projeto abre novas possibilidades de pesquisa e coleta de dados e informações, mas não está apenas vinculado a isso, reforçando a necessidade da colaboração entre a ciência de dados e a saúde pública e privada para conseguir melhorar cada vez meais o fornecimento de conhecimento para que a partir daí as melhoes decisões sejam possíveis de serem feitas. 
