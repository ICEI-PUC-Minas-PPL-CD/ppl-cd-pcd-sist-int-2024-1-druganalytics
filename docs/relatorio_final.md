...
A análise exploratória dos dados revela correlações entre variáveis como idade, gênero, educação e uso de substâncias, ilustradas por gráficos que mostram a distribuição e frequência de uso. Os resultados obtidos, como a acurácia da regressão linear de aproximadamente 40%, embora modestos, permitem insights valiosos sobre os fatores que influenciam o consumo de drogas, embasando medidas preventivas e intervencionistas mais eficazes.
